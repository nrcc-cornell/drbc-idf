...
export const tabsInfo = [
  {
    ...
    "content": 
      <Box key='user-guide' sx={{ padding: '8px' }}>
        ...
        <ParagraphTypography><b>Emission Scenario:</b> Changes the projection based on future emissions.  For CMIP6 models, Shared Socioeconomic Pathways (SSP) are used with options for high (SSP3-7.0), intermediate (SSP2-4.5) and very high (SSP5-8.5) available.  Two Representative Concentration Pathways (RCP) are used for CMIP5 models, these are termed high RCP8.5 and low RCP4.5.</ParagraphTypography>
